...
describe.only("3.1. Promise static", function () {
    ...
    describe("3.1.3. Promise.queue", function () {
        describe("3.1.3.1: Resolved", function () {
            ...
            specify.only("when object and fullfiled promise", function (done) {
                let d2 = deferred();
                let promises = [
                    dummy,
                    d2.promise
    ...
    describe("3.1.4. Promise.stack", function () {
        describe("3.1.4.1: Resolved", function () {
            specify("when empty array", function (done) {
                adapter
                    .stack([])
                    .then(() => done());
        ...
        describe("3.1.4.2: Rejected", function () {
            specify("when immediate rejected", function (done) {
                adapter
                    .stack([rejected(dummy)])
                    .then(null, (r) => {
                        assert.strictEqual(r, dummy);
                        done();
                    });
